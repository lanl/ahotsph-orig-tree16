...
void *SPHRead(char *name,
    ...
    sdfp = SDFreadf(name,
                    ...
                    &ufreezconf,
                    "dtbrn",
                    offsetof(SPHbody, dtbrn),
                    &dtbrnconf,
                    "xhe4n",
                    offsetof(SPHbody, xhe4n),
                    &xhe4nconf,
                    "xc12n",
                    offsetof(SPHbody, xc12n),
                    &xc12nconf,
                    "xo16n",
                    offsetof(SPHbody, xo16n),
                    &xo16nconf,
                    "xne20n",
                    offsetof(SPHbody, xne20n),
                    &xne20nconf,
                    "xmg24n",
                    offsetof(SPHbody, xmg24n),
                    &xmg24nconf,
                    "xsi28n",
                    offsetof(SPHbody, xsi28n),
                    &xsi28nconf,
                    "xni56n",
                    offsetof(SPHbody, xni56n),
                    &xni56nconf,
                    "xco56n",
                    offsetof(SPHbody, xco56n),
                    &xco56nconf,
                    "xfe56n",
                    offsetof(SPHbody, xfe56n),
                    &xfe56nconf,
                    "xpf",
