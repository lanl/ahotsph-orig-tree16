...
void plastic_(float *sxxi, float *syyi, float *szzi, float *sxyi, float *sxzi, float *syzi, float *ui, float *dmi, float *umelti, float *yiei, float *vonmises);
...
void deviator_(float *xmui, float *sxxi, float *syyi, float *szzi, float *sxyi, float *sxzi, float *syzi, float *epsxxi, float *epsyyi, float *epszzi, float *epsxyi, float *epsxzi, float *epsyzi, float *rxyi, float *rxzi, float *ryzi, float *dsxxi, float *dsyyi, float *dszzi, float *dsxyi, float *dsxzi, float *dsyzi);
