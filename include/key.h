...
extern int KeyLE(Key_t key1, Key_t key2);
extern int KeyEQ(Key_t key1, Key_t key2);
extern int KeyNEQ(Key_t key1, Key_t key2);
extern Key_t KeyXOR(Key_t key1, Key_t key2);
extern Key_t KeyAnd(Key_t key1, Key_t key2);
extern Key_t KeyOr(Key_t key1, Key_t key2);
extern int KeyCmp(Key_t key1, Key_t key2);
extern Key_t KeyNot(Key_t key1);
extern Key_t KeyRshift(Key_t u, int b);
extern Key_t KeyLshift(Key_t u, int b);
extern Key_t KeyInt(int i);
extern Key_t KeyOrInt(Key_t u, int i);
extern int KeyAndInt(Key_t u, int i);
extern Key_t KeyAndNotInt(Key_t u, unsigned int i);
extern Key_t KeyAdd(Key_t key1, Key_t key2);
extern Key_t KeySub(Key_t key1, Key_t key2);
extern Key_t KeyAddInt(Key_t key1, int i);
...
INLINE int KeyGT(Key_t key1, Key_t key2) { return (key1.k[0] > key2.k[0]); }

INLINE int KeyLT(Key_t key1, Key_t key2) { return (key1.k[0] < key2.k[0]); }

INLINE int KeyGE(Key_t key1, Key_t key2) { return (key1.k[0] >= key2.k[0]); }

INLINE int KeyLE(Key_t key1, Key_t key2) { return (key1.k[0] <= key2.k[0]); }

INLINE int KeyEQ(Key_t key1, Key_t key2) { return (key1.k[0] == key2.k[0]); }

INLINE int KeyNEQ(Key_t key1, Key_t key2) { return (key1.k[0] != key2.k[0]); }

INLINE Key_t KeyXOR(Key_t key1, Key_t key2) {
    Key_t ret;
    ret.k[0] = key1.k[0] ^ key2.k[0];
    return (ret);
}

INLINE Key_t KeyAnd(Key_t key1, Key_t key2) {
    Key_t ret;
    ret.k[0] = key1.k[0] & key2.k[0];
    return (ret);
}

INLINE Key_t KeyOr(Key_t key1, Key_t key2) {
    Key_t ret;
    ret.k[0] = key1.k[0] | key2.k[0];
    return (ret);
}

INLINE int KeyCmp(Key_t key1, Key_t key2) {
...
INLINE Key_t KeyNot(Key_t key1) {
    key1.k[0] = ~key1.k[0];
    return key1;
}

INLINE Key_t KeyRshift(Key_t u, int b) {
    Key_t ret;
    ret.k[0] = u.k[0] >> b;
    return (ret);
}

INLINE Key_t KeyLshift(Key_t u, int b) {
    Key_t ret;
    ret.k[0] = u.k[0] << b;
    return (ret);
}
...
/* cast int to Key_t */
INLINE Key_t KeyInt(int i) {
    Key_t ret;
    ret.k[0] = i;
    return (ret);
}

INLINE Key_t KeyOrInt(Key_t u, int i) {
    Key_t ret;
    ret.k[0] = u.k[0] | i;
    return (ret);
}
...
INLINE int KeyAndInt(Key_t u, int i) { return (u.k[0] & i); }
...
INLINE Key_t KeyAndNotInt(Key_t u, unsigned int i) {
    u.k[0] &= ~((_KTYPE)i);
    return u;
}

INLINE Key_t KeyAdd(Key_t key1, Key_t key2) {
    Key_t ret;
...
INLINE Key_t KeySub(Key_t key1, Key_t key2) {
    Key_t ret;
...
INLINE Key_t KeyAddInt(Key_t key1, int i) {
    Key_t ret;
...
INLINE int KeyGT(Key_t key1, Key_t key2) {
...
INLINE int KeyLT(Key_t key1, Key_t key2) {
    if (key1.k[1] < key2.k[1])
        return 1;
    else if (key1.k[1] > key2.k[1])
        return 0;
...
INLINE int KeyGE(Key_t key1, Key_t key2) {
    if (key1.k[1] > key2.k[1])
        return 1;
    else if (key1.k[1] < key2.k[1])
        return 0;
...
INLINE int KeyLE(Key_t key1, Key_t key2) {
    if (key1.k[1] < key2.k[1])
        return 1;
    else if (key1.k[1] > key2.k[1])
        return 0;
...
INLINE int KeyEQ(Key_t key1, Key_t key2) {
    return (key1.k[0] == key2.k[0] && key1.k[1] == key2.k[1]);
}

INLINE int KeyNEQ(Key_t key1, Key_t key2) {
    return (key1.k[0] != key2.k[0] || key1.k[1] != key2.k[1]);
}
