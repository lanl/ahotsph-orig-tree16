...
extern "C" {
#endif /* __cplusplus */
extern void ChnInit(Chn *new, int sz, int nalloc, void *(*realloc_like)(void *, size_t));
...
INLINE int ChnFreeCnt(Chn *id) { return id->free_cnt; }

INLINE int ChnAllocCnt(Chn *id) { return id->nmalloced - id->free_cnt; }

INLINE size_t ChnUnitSz(Chn *id) { return id->sz; }
