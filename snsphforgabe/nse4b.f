...
c use nse4b.f with newsph36.f subroutine nsestart(t9fnl, rhofnl, yefnl, yp, yn)
    parameter(nsetol = 1d - 5, kmax = 100) implicit double precision(a - h, o - z) T9start
...
c           dgn2=0.d0
            ...
            DO 30 n=1,nmax
              ...
              znt=zn(n)
              zat=za(n)
              yt=dexp(amax1(dlgalp(n)+zpt*dlgyp+znt*dlgyn+h(iz),-50.))
