...
/* Eleven args! */
#define Velv(a, b, c, d, e, f, g, h, i, j, k)                   \
    do {                                                        \
...
#define Dotx(a, b) (GLUE(a, 0) * GLUE(b, 0) + GLUE(a, 1) * GLUE(b, 1) + GLUE(a, 2) * GLUE(b, 2))
...
/* Use in prototypes */
#define Vxp(a) GLUE(a, 0), GLUE(a, 1), GLUE(a, 2)
...
#define Dotx(a, b) (GLUE(a, 0) * GLUE(b, 0) + GLUE(a, 1) * GLUE(b, 1))
