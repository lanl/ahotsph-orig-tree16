	      ...
	      int (*cmp)(const void *, const void *))
{
    ...
    if (total_elems > MAX_THRESH) {
        ...
        jump_over:;
            ...
            do {
                while ((*cmp)((void *)left_ptr, (void *)pivot) < 0) left_ptr += size;

                while ((*cmp)((void *)pivot, (void *)right_ptr) < 0) right_ptr -= size;
        ...
        while ((run_ptr += size) <= end_ptr) {
            ...
            if (tmp_ptr != run_ptr) {
                ...
                while (--trav >= (int *)run_ptr) {
                    ...
                    for (hi = lo = trav; (lo -= size / sizeof(int)) >= (int *)tmp_ptr; hi = lo)
                        *hi = *lo;
                    *hi = c;
                }
            }
