...
/* Add the stretching term to the viscous interaction. The symmetric
   scheme is used */
	...
	Dstr(bp)[2] += 0.5F *( (Gradvel(bp)[2][0]+Gradvel(bp)[0][2])
        ...
        Dstr(bp)[0] += Gradvel(bp)[0][0] * Strength(bp)[0] + Gradvel(bp)[1][0] * Strength(bp)[1]
                       + Gradvel(bp)[2][0] * Strength(bp)[2];

        Dstr(bp)[1] += Gradvel(bp)[0][1] * Strength(bp)[0] + Gradvel(bp)[1][1] * Strength(bp)[1]
                       + Gradvel(bp)[2][1] * Strength(bp)[2];

        Dstr(bp)[2] += Gradvel(bp)[0][2] * Strength(bp)[0] + Gradvel(bp)[1][2] * Strength(bp)[1]
