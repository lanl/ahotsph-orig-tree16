...
static int
read0(int fd, void *buf, unsigned int nbytes)
{
    int ret;
...
static int
write0(int fd, const void *buf, unsigned int nbytes)
{
    int ret;
...
static int 
lseek0(int fd, long offset, int whence)
{
    int ret;
...
static int 
fseekrd0(int fd, long offset, int whence, void *buf, int reclen,
	 int nrecs)
{
    int doseek;
    int real_whence;
...
static int
read0_multi(int fd, void *buf, unsigned int nbytes)
{
    int ret;
    int *sizes;
    int i, n;
