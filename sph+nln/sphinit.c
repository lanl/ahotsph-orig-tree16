		...
		int set_id, int setpvel, float new_h, float new_u)
{
	...
	sdfp = SDFreadf(name, (void **)btabp, gnobjp, nobjp, sizeof(SPHbody),
			...
			"f1", offsetof(SPHbody, nucnetw.abund[0]), &f1conf,
			"f2", offsetof(SPHbody, nucnetw.abund[1]), &f1conf,
			"f3", offsetof(SPHbody, nucnetw.abund[2]), &f1conf,
			"f4", offsetof(SPHbody, nucnetw.abund[3]), &f1conf,
			"f5", offsetof(SPHbody, nucnetw.abund[4]), &f1conf,
			"f6", offsetof(SPHbody, nucnetw.abund[5]), &f1conf,
			"f7", offsetof(SPHbody, nucnetw.abund[6]), &f1conf,
			"f8", offsetof(SPHbody, nucnetw.abund[7]), &f1conf,
			"f9", offsetof(SPHbody, nucnetw.abund[8]), &f1conf,
			"f10", offsetof(SPHbody, nucnetw.abund[9]), &f1conf,
			"f11", offsetof(SPHbody, nucnetw.abund[10]), &f1conf,
			"f12", offsetof(SPHbody, nucnetw.abund[11]), &f1conf,
			"f13", offsetof(SPHbody, nucnetw.abund[12]), &f1conf,
			"f14", offsetof(SPHbody, nucnetw.abund[13]), &f1conf,
			"f15", offsetof(SPHbody, nucnetw.abund[14]), &f1conf,
			"f16", offsetof(SPHbody, nucnetw.abund[15]), &f1conf,
			"f17", offsetof(SPHbody, nucnetw.abund[16]), &f1conf,
			"f18", offsetof(SPHbody, nucnetw.abund[17]), &f1conf,
			"f19", offsetof(SPHbody, nucnetw.abund[18]), &f1conf,
			"f20", offsetof(SPHbody, nucnetw.abund[19]), &f1conf,
			/*
