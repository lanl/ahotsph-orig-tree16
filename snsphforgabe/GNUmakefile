...
ifndef prog
src=cofm.c grav.c mac.c main.c physics.c print.c integrate.c \
	sphcofm.c sph.c sphinit.c physics_sph.c shrink.c sphprint.c sphplus.c \
	SDFreadf.c sn.c

fsrc=eos3.f sleos.f nse4d.f ocean.f eosgen.f
...
ifeq ($(findstring icc,$(defaultCC)),icc)
...
# 	$(FC) $(FFLAGS) -mp1 -c eos3.f
# 	mv eos3$(objsuf) $(objdir)

# $(objdir)/nse4d$(objsuf) : nse4d.f
# 	$(FC) $(FFLAGS) -mp1 -c nse4d.f
# 	mv nse4d$(objsuf) $(objdir)
# endif
...
$(objdir)/sphcofm$(objsuf): ndim.h $(treedir)/include/vop.h $(treedir)/include/Msgs.h
$(objdir)/sphcofm$(objsuf): $(treedir)/include/fastflpt.h $(treedir)/include/protos.h
$(objdir)/sph$(objsuf):
$(objdir)/sph$(objsuf):
$(objdir)/sph$(objsuf):
$(objdir)/sph$(objsuf):
...
$(objdir)/sph$(objsuf): $(treedir)/include/pqsort.h ndim.h $(treedir)/include/vop.h
$(objdir)/sph$(objsuf): $(treedir)/include/fastflpt.h $(treedir)/include/singlio.h $(treedir)/include/mpmy.h
$(objdir)/sph$(objsuf): physics.h $(treedir)/include/physics_generic.h
...
$(objdir)/physics_sph$(objsuf):
$(objdir)/physics_sph$(objsuf):
$(objdir)/physics_sph$(objsuf): physics_sph.h
$(objdir)/physics_sph$(objsuf): $(treedir)/include/tree.h
$(objdir)/physics_sph$(objsuf):
...
$(objdir)/physics_sph$(objsuf): $(treedir)/include/Assert.h $(treedir)/include/pqsort.h ndim.h
...
$(objdir)/sphprint$(objsuf): $(treedir)/include/Assert.h $(treedir)/include/pqsort.h ndim.h
...
$(objdir)/sphplus$(objsuf): $(treedir)/include/bigmalloc.h
$(objdir)/sphplus$(objsuf): $(treedir)/include/error.h $(treedir)/include/gccextensions.h physics.h
$(objdir)/sphplus$(objsuf): $(treedir)/include/tree.h $(treedir)/include/timers.h $(treedir)/include/key.h
$(objdir)/sphplus$(objsuf):
$(objdir)/sphplus$(objsuf):
...
$(objdir)/sphplus$(objsuf): $(treedir)/include/vop.h $(treedir)/include/mpmy.h $(treedir)/include/SDF.h
$(objdir)/sphplus$(objsuf): $(treedir)/include/SDFwrite.h $(treedir)/include/singlio.h
...
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf): physics_sph.h $(treedir)/include/tree.h
$(objdir)/sn$(objsuf): $(treedir)/include/timers.h $(treedir)/include/key.h
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf): $(treedir)/include/stk.h $(treedir)/include/bigmalloc.h $(treedir)/include/error.h
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf): $(treedir)/include/gccextensions.h $(treedir)/include/chn.h $(treedir)/include/Assert.h
$(objdir)/sn$(objsuf): $(treedir)/include/pqsort.h ndim.h $(treedir)/include/vop.h $(treedir)/include/singlio.h
$(objdir)/sn$(objsuf): $(treedir)/include/mpmy.h $(treedir)/include/fastflpt.h $(treedir)/include/randoms.h
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf):
$(objdir)/sn$(objsuf):
