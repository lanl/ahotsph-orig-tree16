...
void InteractBody(body *bp, bodyptr me, float eps2inv12, float nu) {
                                ...
                                * (OO5
                                   - OO3 * r2o2
                                         * (OO7
                                            - OO4 * r2o2
                                                  * (OO9
                                                     - OO5 * r2o2 * (OO11 - OO6 * r2o2 * OO13))))));
        cf1 = eps2inv32 * SQRT2OPI
              * (OO3
                 - r2o2
                       * (OO5
                          - OO2 * r2o2
                                * (OO7
                                   - OO3 * r2o2
                                         * (OO9
                                            - OO4 * r2o2
                                                  * (OO11
                                                     - OO5 * r2o2 * (OO13 - OO6 * r2o2 * OO15))))));
        cf3 = eps2inv52 * SQRT2OPI
              * (OO5
                 - r2o2
                       * (OO7
                          - OO2 * r2o2
    ...
    Dstr(me)[0] += tmp * (Vol(me) * Strength(bp)[0] - Vol(bp) * Strength(me)[0]);
    Dstr(me)[1] += tmp * (Vol(me) * Strength(bp)[1] - Vol(bp) * Strength(me)[1]);
    Dstr(me)[2] += tmp * (Vol(me) * Strength(bp)[2] - Vol(bp) * Strength(me)[2]);
}
