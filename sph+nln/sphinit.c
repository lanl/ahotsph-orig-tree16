...
void *WindRead(char *name, void *csdfp, windbody **btabp, int *gnobjp, int *nobjp) {
    ...
    sdfp = SDFreadwind(name,
                       ...
                       sizeof(windbody),
                       "xwind",
                       offsetof(windbody, pos[0]),
                       &xconf,
                       "ywind",
                       offsetof(windbody, pos[1]),
                       &yconf,
                       "zwind",
                       offsetof(windbody, pos[2]),
                       &zconf,
                       "vxwind",
                       offsetof(windbody, vel[0]),
                       &vxconf,
                       "vywind",
                       offsetof(windbody, vel[1]),
                       &vyconf,
                       "vzwind",
                       offsetof(windbody, vel[2]),
                       &vzconf,
                       "rhowind",
                       offsetof(windbody, rhowind),
                       &rhoconf,
                       "vwind",
                       offsetof(windbody, vwind),
                       &vwindconf,
                       "uwind",
                       offsetof(windbody, uwind),
                       &uwindconf,
                       "identwind",
